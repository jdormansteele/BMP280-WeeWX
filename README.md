...
This service definition was developed and tested for a weather station with the elements listed below. It is assumed that you have something functionally equivalent before tackling the procedure described here. 
...
* Note: After writing this, I discovered a forum thread dealing with same issue in 2017-2018, https://groups.google.com/g/weewx-development/c/3LCx5b4mveM/m/Sg9xsj5aAQAJ. I haven't tested the embedded code there, which relies on an early version of the same Adafruit driver. My end product, using eyesnz's code as a model, avoids references to BME280 and has a simpler data structure. 
